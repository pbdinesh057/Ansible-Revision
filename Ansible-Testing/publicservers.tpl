...
[pip]
${testserver01} ansible_user=ubuntu ansible_ssh_private_key_file=/etc/ansible/ansiblekey.pem 
${testserver02} ansible_user=ubuntu ansible_ssh_private_key_file=/etc/ansible/ansiblekey.pem 
${testserver03} ansible_user=ubuntu ansible_ssh_private_key_file=/etc/ansible/ansiblekey.pem 